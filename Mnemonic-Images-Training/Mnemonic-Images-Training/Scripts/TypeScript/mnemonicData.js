...
(function (mnemonicApp) {
    var mnemonicData = (function () {
        ...
        mnemonicData.prototype.getAlphabetImages = function (begin, end, random) {
            ...
            ;
            if (begin || end) {
                var straightArray = this.pushArray(begin, end + 1, this.mnemonicAlphabetImages);
            }
            if (!random) {
        ...
        mnemonicData.prototype.getDaysImages = function (begin, end, random) {
            ...
            ;
            if (begin || end) {
                var straightArray = this.pushArray(begin, end + 1, this.mnemonicDaysImages);
            }
            if (!random) {
                return straightArray;
            }
        ...
        mnemonicData.prototype.getMonthsImages = function (begin, end, random) {
            ...
            ;
            if (begin || end) {
                var straightArray = this.pushArray(begin, end + 1, this.mnemonicMonthImages);
            }
            if (!random) {
                return straightArray;
            }
        ...
        mnemonicData.prototype.getNumberImages = function (begin, end, random) {
            ...
            ;
            if (begin || end) {
                var straightArray = this.pushArray(begin, end + 1, this.mnemonicNumberImages);
            }
            if (!random) {
                return straightArray;
            }
        ...
        mnemonicData.prototype.getNameImages = function (begin, end, random) {
            if (!begin && !end) {
            ...
            ;
            if (begin || end) {
                var straightArray = this.pushArray(begin, end + 1, this.mnemonicNameImages);
            }
            if (!random) {
                return straightArray;
            }
